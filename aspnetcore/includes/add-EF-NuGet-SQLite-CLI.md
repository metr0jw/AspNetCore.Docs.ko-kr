<span data-ttu-id="2b5ec-101">다음 .NET Core CLI 명령을 실행합니다.</span><span class="sxs-lookup"><span data-stu-id="2b5ec-101">Run the following .NET Core CLI commands:</span></span>
